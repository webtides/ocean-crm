		...
		return html`
			<form method="get" class="flex items-center">
				<div class="flex w-full bg-white rounded shadow">
				  <dropdown-button class="block focus:z-10 px-4 hover:bg-gray-100 border-r focus:border-white rounded-l focus:ring md:px-6">
				  ...
				  <input class="relative px-6 py-3 w-full rounded-r focus:shadow-outline" autocomplete="off" type="text" name="search" placeholder="Search…" value="${this.search}" />
				</div>
				<button class="ml-3 text-gray-500 hover:text-gray-700 focus:text-indigo-500 text-sm" type="submit">Filter</button>
		  </form>
		`;
	}
}
