...
export default class {
	...
	template() {
		return html`
			<div>Hey there! Welcome to Ocean CRM, a demo app designed to help demonstrate how luna-js and element-js work.</div>
			<div class="mt-10">
				...
				<dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
					<div class="relative bg-white pt-5 px-4 pb-12 sm:pt-6 sm:px-6 shadow rounded-lg overflow-hidden">
						...
						<dd class="ml-16 pb-6 flex items-baseline sm:pb-7">
							...
							<div class="absolute bottom-0 inset-x-0 bg-gray-50 px-4 py-4 sm:px-6">
								<div class="text-sm">
									<a href="/organizations" class="font-medium text-indigo-600 hover:text-indigo-500"> View all<span class="sr-only"> Total Subscribers stats</span></a>
								</div>
							</div>
						</dd>
					</div>
					...
					<div class="relative bg-white pt-5 px-4 pb-12 sm:pt-6 sm:px-6 shadow rounded-lg overflow-hidden">
						<dt>
							...
							<p class="ml-16 text-sm font-medium text-gray-500 truncate">Avg. Contact Interaction</p>
						</dt>
						<dd class="ml-16 pb-6 flex items-baseline sm:pb-7">
							...
							<div class="absolute bottom-0 inset-x-0 bg-gray-50 px-4 py-4 sm:px-6">
								<div class="text-sm">
									<a href="/contacts" class="font-medium text-indigo-600 hover:text-indigo-500"> View all<span class="sr-only"> Avg. Open Rate stats</span></a>
								</div>
							</div>
						</dd>
					</div>
